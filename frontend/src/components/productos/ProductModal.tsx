...
export interface ProductModalProps {
     ...
     * · 'ESTANDAR' → desde Productos (tipo fijo, sin estadoConservacion)
     * · 'RETRO'    → desde Bóveda/Tasador (tipo fijo, con estadoConservacion)
     * · undefined  → modo edición (tipo read-only, estadoConservacion visible si RETRO)
     */
            ...
            <div
                ...
                <form onSubmit={handleSubmit} noValidate>
                    <div style={{ padding: '24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                        ...
                        {/* ── Tipo producto: read-only badge en edición ───── */}
                        {producto && (
                            <div>
                                ...
                                <div style={{
                                    ...
                                    borderRadius:  '6px',
                                    padding:       '9px 12px',
                                    background:    form.tipoProducto === 'RETRO'
                        ...
                        {/* ── Estado conservación: solo visible para RETRO ─ */}
