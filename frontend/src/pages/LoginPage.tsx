...
export function LoginPage(): JSX.Element {
    ...
    async function handleSubmit(e: FormEvent<HTMLFormElement>): Promise<void> {
        ...
        try {
            ...
            // useAuth.login() redirige automáticamente al hacer navigate
            // No hace falta navigate aquí — lo gestiona ProtectedRoute (FE-07)
                ...
                <div style={{
                    ...
                    <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                        <div style={{
                            ...
                            <span style={{
                                ...
                                color: '#00d4ff', letterSpacing: '0.22em', textTransform: 'uppercase',
                            }}>
                                LEVELUP ARCADE
                            </span>
                    ...
                    <div style={{ position: 'relative' }}>
                        <div style={{
                            ...
                            background: 'linear-gradient(135deg, #00ff88, #00d4ff, #005588, #00d4ff, #00ff88)',
                                    ...
                                    <div style={{ position: 'relative' }}>
                                        ...
                                        <button
                                            ...
                                            style={{
                                                ...
                                                letterSpacing: '0.10em', color: '#4a4a6a',
                                ...
                                <button
                                    ...
                                    onMouseEnter={e => {
                                        if (status !== 'loading') {
                                            ...
                                            (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 36px rgba(0,212,255,0.35)';
                                        }
                                    }}
                                    onMouseLeave={e => {
                                        (e.currentTarget as HTMLButtonElement).style.opacity = '1';
                                        (e.currentTarget as HTMLButtonElement).style.transform = 'translateY(0)';
                                        (e.currentTarget as HTMLButtonElement).style.boxShadow = '0 0 24px rgba(0,212,255,0.20)';
                                    }}
                                >
