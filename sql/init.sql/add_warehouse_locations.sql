-- ============================================================
--  LevelUp Nexus ERP — add_warehouse_locations.sql (Docker)
--  Se ejecuta automáticamente en el orden del docker-compose.
--  Sincronizado con la migración de Flyway V4.
--  Versión: v1.2.0
--  ─────────────────────────────────────────────────────────
--  NOTA: Los productos ya vienen con id_ubicacion asignado
--  en este entorno vía JOIN con ubicaciones_almacen. Este script
...
--  entorno Docker, aquí es donde se asignan de forma directa.
-- ============================================================
